...
## [3.10.0](https://github.com/ElasticProvisioner/fluent-operator/compare/v3.9.0...v3.10.0) (2026-06-28)
...
* add envFrom support for fluentd daemonset and statefulsets ([bda6ebd](https://github.com/ElasticProvisioner/fluent-operator/commit/bda6ebd22e401e9af201a1975b05ad38c12331a8))
...
* add HostAliases support to Fluent Bit and Fluentd specifications ([#1413](https://github.com/ElasticProvisioner/fluent-operator/issues/1413)) ([c9150cd](https://github.com/ElasticProvisioner/fluent-operator/commit/c9150cd16d478ad2415636efedaefec8f385a6a6))
* Add livenessProbe to FluentBit template (fluentbit-fluentBit.yaml) ([6187276](https://github.com/ElasticProvisioner/fluent-operator/commit/61872761f043f2a7663ab9e08654536a74d0ff11))
...
* add pipeline to bump fluent bit version ([#1448](https://github.com/ElasticProvisioner/fluent-operator/issues/1448)) ([9798273](https://github.com/ElasticProvisioner/fluent-operator/commit/9798273621be71d9177095dd5a8ffacc034e4582))
* add rdkafka gem installation to Dockerfiles for fluent-watcher ([#1415](https://github.com/ElasticProvisioner/fluent-operator/issues/1415)) ([92df045](https://github.com/ElasticProvisioner/fluent-operator/commit/92df045557f5f9f308f09a714dc6587781f2343f))
...
* add support for envfrom on fluentd ([b0a5b82](https://github.com/ElasticProvisioner/fluent-operator/commit/b0a5b821d572e870d4f9340d7a99ceb20ed9cdd7))
* Add support for reload_after, sniffer_class_name es output parameters ([6c6016a](https://github.com/ElasticProvisioner/fluent-operator/commit/6c6016a2ccd2600f86dfd423cbf32b4933facde8))
* Add support for reload_after, sniffer_class_name es output parameters ([68171fe](https://github.com/ElasticProvisioner/fluent-operator/commit/68171fee3231ac874785566b73bf18ba9e6208aa))
* add VERSION file for fluentbit image ([abccb78](https://github.com/ElasticProvisioner/fluent-operator/commit/abccb7898253fca2895fa26b67313316e2686b22))
...
* filter ordinals ([#1386](https://github.com/ElasticProvisioner/fluent-operator/issues/1386)) ([cc23366](https://github.com/ElasticProvisioner/fluent-operator/commit/cc23366ea3edfe3d84d946a9d1625086c2205901))
...
* improve pipelines and add documents ([dd91ab5](https://github.com/ElasticProvisioner/fluent-operator/commit/dd91ab526453dfdbb7706b2bbb1ec8fb48d6a003))
...
* support fluentbit tail offsetKey parameters ([#1437](https://github.com/ElasticProvisioner/fluent-operator/issues/1437)) ([a12acde](https://github.com/ElasticProvisioner/fluent-operator/commit/a12acde64d4f83bc197a7d1594438d271aeb68d4))
* update pr as requested ([9dd2abf](https://github.com/ElasticProvisioner/fluent-operator/commit/9dd2abf30d1a4a430a40afe95ec25edc557bdfbe))
...
* missing cloudAuth/cloudId pair inserts ([2f1c90b](https://github.com/ElasticProvisioner/fluent-operator/commit/2f1c90b35e43c2b257559039e3c24775e0a3587d))
* missing cloudAuth/cloudId pair inserts ([842c7e2](https://github.com/ElasticProvisioner/fluent-operator/commit/842c7e27dfe3d7af515c5bab59be35d2e42d21f7))
...
* **deps:** Bump alpine in /cmd/fluent-watcher/fluentd ([#1434](https://github.com/ElasticProvisioner/fluent-operator/issues/1434)) ([09d04d5](https://github.com/ElasticProvisioner/fluent-operator/commit/09d04d5e783bec1ae57615d07e5bdf2fd316865f))
* **deps:** Bump aquasecurity/trivy-action from 0.24.0 to 0.29.0 ([#1426](https://github.com/ElasticProvisioner/fluent-operator/issues/1426)) ([4c7eaa8](https://github.com/ElasticProvisioner/fluent-operator/commit/4c7eaa88c4592a918ad43ec00df9aa496976e931))
...
* **deps:** Bump arm64v8/ruby in /cmd/fluent-watcher/fluentd ([#1443](https://github.com/ElasticProvisioner/fluent-operator/issues/1443)) ([9fe37ca](https://github.com/ElasticProvisioner/fluent-operator/commit/9fe37ca415615d80ebc1b6b1cd1217539f4caecc))
...
* **deps:** Bump golang in /cmd/fluent-manager ([#1430](https://github.com/ElasticProvisioner/fluent-operator/issues/1430)) ([f8cc0d7](https://github.com/ElasticProvisioner/fluent-operator/commit/f8cc0d7fbccbdda0f2e3d6813177963f4e4aa4dd))
* **deps:** Bump golang in /cmd/fluent-watcher/fluentbit ([#1429](https://github.com/ElasticProvisioner/fluent-operator/issues/1429)) ([966e2d6](https://github.com/ElasticProvisioner/fluent-operator/commit/966e2d668be9309c8372bf30050e74217a9faa28))
* **deps:** Bump golang in /cmd/fluent-watcher/fluentd ([#1431](https://github.com/ElasticProvisioner/fluent-operator/issues/1431)) ([30bb13b](https://github.com/ElasticProvisioner/fluent-operator/commit/30bb13b7d324e0cf89d62f21ba7b8f71eace345c))
* **deps:** Bump golang in /docs/best-practice/forwarding-logs-via-http ([#1446](https://github.com/ElasticProvisioner/fluent-operator/issues/1446)) ([23e1c26](https://github.com/ElasticProvisioner/fluent-operator/commit/23e1c26d9e72203694ce8e36a8f8f68f74dd1af5))
...
* **deps:** Bump helm/kind-action from 1.10.0 to 1.12.0 ([#1445](https://github.com/ElasticProvisioner/fluent-operator/issues/1445)) ([4329b66](https://github.com/ElasticProvisioner/fluent-operator/commit/4329b660a44639c827fb2a6ceb197c49136cc900))
